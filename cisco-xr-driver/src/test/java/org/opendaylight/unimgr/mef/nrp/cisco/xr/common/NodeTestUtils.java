...
public class NodeTestUtils {
    ...
    public static Optional<Node> mockNetconfNode(boolean withNetconfCapabilities) {
        ...
        if(withNetconfCapabilities) {
            netconfCapabilityList.add(NetconfConstants.CAPABILITY_IOX_L2VPN);
            netconfCapabilityList.add(NetconfConstants.CAPABILITY_IOX_IFMGR);
            netconfCapabilityList.add(NetconfConstants.CAPABILITY_IOX_ASR9K_POLICYMGR);
        }
