...
public class FcRouteActivatorServiceTest {
    ...
    private FcRouteActivatorService service;
    private ActivationDriverRepoServiceImpl repo;

    @Before
    public void setUp() throws Exception {
        service = new FcRouteActivatorService();

        repo = new ActivationDriverRepoServiceImpl();
        service.setActivationRepoService(repo);
    }
    ...
    public void testActivateSingleNode() throws Exception {
        ...
        repo.setDriverBuilders(Arrays.asList(
    ...
    public void testActivateTwoNodesSingleVendor() throws Exception {
        ...
        repo.setDriverBuilders(Collections.singletonList(
